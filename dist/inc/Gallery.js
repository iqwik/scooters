...
import css from '../../assets/css/ImageGallery.css';
...
export class Gallery extends React.PureComponent
{
    ...
    //     {
    //         // setTimeout(() => { this.props.onload(false) }, 350)
    ...
    _renderItem = (item) => {
        ...
        return (
            <div className={css.imageGalleryImage}>
                ...
                { item.description && <span className={css.imageGalleryDescription}>{item.description}</span> }
            </div>
        );
    };
